...
//	class Engine: public TuioListener {
	...
	public:
		...
		void modelRotationinit(float x, float y, float z);
		void modelRotation(float xpos, float ypos, float zpos);
		void modelTranslateRotation(float xpos, float ypos, float zpos);
		bool transformRotMatToQuaternion(float &qx, float &qy, float &qz, float &qw, mat4 matrix);
/*
...
//*/
		...
		glm::vec3 tempOrigin; //for virtual sphere
	};
